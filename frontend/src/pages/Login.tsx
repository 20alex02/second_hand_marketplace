...
function Login () {
    ...
    return (
        ...
        <Card className='login-card'>
            <Typography.Title level={2} className='login-card__title'>Login</Typography.Title>
            <Form
            ...
            >
                ...
                <Form.Item>
                    <Button type="primary" htmlType="button" className='login-card__button' onClick={() => navigate("/Register")}>
                        Register
                    </Button>
